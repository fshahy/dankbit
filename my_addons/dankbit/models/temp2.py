...
class Trade(models.Model):
    ...
    def get_last_trades(self):
        ...
        tomorrows_instruments = [
            inst for inst in instruments 
            if inst["expiration_timestamp"] == tomorrows_ts and 
            inst["kind"] == "option"
        ]
        ...
        if start_ts:
            ...
            for inst in tomorrows_instruments:
                # _logger.info("+++++++++++++++++++++++++++++++++")
                params = {
                ...
                if "result" in resp:
                    ...
                    for trd in trades:
                        self._create_new_trade(trd, self._get_tomorrows_ts())
